...
import com.login.noteapp.auth.Login;
import com.login.noteapp.auth.Register;
import com.login.noteapp.model.Note;
import com.login.noteapp.note.AddNote;
import com.login.noteapp.note.EditNote;
import com.login.noteapp.note.NoteDetail;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addNoteFab = findViewById(R.id.addNoteFloat);
...
//                startActivity(new Intent(view.getContejxt(), AddNote.class));
...
//        });
    ...
    private int getRandomColor() {
        ...
        colorCode.add(R.color.offwhite);
